...
<head>
    <meta charset="UTF-8">
    <title>myArt+ | <?php echo $t['privacy_page_title']; ?></title>
...
<div class="marquee-wrap"><div class="marquee-text">★ WELCOME TO MYART+ ★ SHARE YOUR ART WITH THE WORLD ★ JOIN THE FORUM ★ NEW EVENTS POSTED WEEKLY ★</div></div>
    ...
    <table width="960" border="0" cellpadding="0" cellspacing="0" align="center" class="main-wrapper" style="margin: 0 auto;">
        ...
        <tr height="30">
            <td>
                <?php $current_page = 'privacy'; include 'navbar.php'; ?>
            </td>
        </tr>
        ...
        <tr>
            <td valign="top" style="padding: 10px 8px;">
                <div class="box">
                    <div class="header-blue"><?php echo $t['privacy_page_title']; ?></div>
                    <div style="padding: 15px; font-size: 12px;">
                        <div class="content-updated"><?php echo $t['privacy_updated']; ?></div>

                        <?php for ($i = 1; $i <= $privacy_section_count; $i++): ?>
                            <div class="content-section">
                                <h3><?php echo $t['privacy_s' . $i . '_title']; ?></h3>
                                <p><?php echo $t['privacy_s' . $i . '_body']; ?></p>
                            </div>
                        <?php endfor; ?>

                        <div class="content-contact-note">
                            <strong><?php echo $t['questions_title']; ?></strong> <?php echo $t['contact_prompt']; ?> <a href="mailto:<?php echo $t['site_contact_email']; ?>"><?php echo $t['site_contact_email']; ?></a>
                        </div>
                    </div>
                </div>
            </td>
